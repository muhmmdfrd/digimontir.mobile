...
Assignment _$AssignmentFromJson(Map<String, dynamic> json) => Assignment(
  ...
  latCheckIn: (json['lat_check_in'] as num?)?.toDouble(),
  lngCheckIn: (json['lng_check_in'] as num?)?.toDouble(),
  checkInPhotoPath: json['check_in_photo_path'] as String?,
  checkOutPhotoPath: json['check_out_photo_path'] as String?,
  latCheckOut: (json['lat_check_out'] as num?)?.toDouble(),
  lngCheckOut: (json['lng_check_out'] as num?)?.toDouble(),
